...
describe('UserRepository', () => {
  ...
  it('should return a user by email when a different user exists', async () => {
    // Замените emailValue на другой существующий в вашей базе данных адрес электронной почты
    const emailValue = 'newuser@example.com';

    // Вызываем метод getUserByEmail с другим существующим email
